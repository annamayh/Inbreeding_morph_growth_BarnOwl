...
bill_df = bill_df[bill_df$gr_stage == "Adult", ]
...
mod_bill_GRM.split_stage_h2_adult <- brm(BillLength ~  1 +sex+FROH+
...
summary(mod_bill_GRM.split_stage_h2_adult) ###

saveRDS(mod_bill_GRM.split_stage_h2_adult,file=paste0(scratch,"2.1.bill_split_stage_adult_FROH.RDS")) ##
