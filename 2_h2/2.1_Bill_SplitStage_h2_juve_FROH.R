...
bill_df = bill_df[bill_df$gr_stage == "Juvenile", ]
...
mod_bill_GRM.split_stage_h2_juve <- brm(BillLength ~  1 +sex+age_acc+FROH+
...
summary(mod_bill_GRM.split_stage_h2_juve) ###

saveRDS(mod_bill_GRM.split_stage_h2_juve,file=paste0(scratch,"2.1.bill_split_stage_juve_FROH.RDS")) ##
