...
mass_df = mass_df[mass_df$gr_stage == "Juvenile", ]
...
mod_mass_GRM.split_stage_h2_juve <- brm(Mass ~  1 +sex+mc_age_acc+FROH+ # 
...
saveRDS(mod_mass_GRM.split_stage_h2_juve,file=paste0(scratch,"2.2.mass_split_h2_juve_FROH.RDS")) ##

summary(mod_mass_GRM.split_stage_h2_juve) ###
